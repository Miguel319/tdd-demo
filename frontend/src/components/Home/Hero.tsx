            ...
            <div className="w-full md:w-1/2">
              <div className="max-w-lg">
                <h1 className="text-2xl font-semibold text-gray-800 uppercase dark:text-white md:text-3xl">
                  Find your dream{" "}
                  <span className="text-blue-600">dev job </span>{" "}
                </h1>
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                  <h3>
                    Through apply-j, hundreds of tech companies post several job
                    posts on a daily basis. You can apply with a single click.
                  </h3>
                </p>
              </div>
            </div>
